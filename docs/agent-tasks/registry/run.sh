#!/usr/bin/env bash
# file: docs/agent-tasks/registry/run.sh
# version: 1.0.0
# guid: 0c5dce5c-6f73-45f4-b65a-570e6e139551
# last-edited: 2026-07-16
# Thin wrapper for the registry workstream. See orchestration.md for wave order
