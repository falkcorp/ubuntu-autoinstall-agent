#!/usr/bin/env bash
# file: docs/agent-tasks/luks-keys/run.sh
# version: 1.0.0
# guid: eb778790-70e0-44e1-bfdf-8622c287df5a
# last-edited: 2026-07-10
# Thin wrapper for the luks-keys workstream. See orchestration.md for wave order.
