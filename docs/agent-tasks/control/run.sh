#!/usr/bin/env bash
# file: docs/agent-tasks/control/run.sh
# version: 1.0.0
# guid: f61f055c-0a73-41b8-a46f-13afdfa5e1c8
# last-edited: 2026-07-10
# Thin wrapper for the control workstream. See orchestration.md for wave order.
