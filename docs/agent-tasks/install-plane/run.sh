#!/usr/bin/env bash
# file: docs/agent-tasks/install-plane/run.sh
# version: 1.0.0
# guid: c3f86a60-9f72-4780-875f-5d531be25a34
# last-edited: 2026-07-10
# Thin wrapper for the install-plane workstream. See orchestration.md for wave order.
