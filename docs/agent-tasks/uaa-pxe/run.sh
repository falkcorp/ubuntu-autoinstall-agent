#!/usr/bin/env bash
# file: docs/agent-tasks/uaa-pxe/run.sh
# version: 1.0.0
# guid: 089d087a-61c8-4c66-9ec5-6347af9d62a2
# last-edited: 2026-07-10
# Thin wrapper for the uaa-pxe workstream. See orchestration.md for wave order.
