#!/usr/bin/env bash
# file: docs/agent-tasks/profiles/run.sh
# version: 1.0.0
# guid: da0a5b4b-9d99-46e7-a49e-13010f0d1fcf
# last-edited: 2026-07-16
# Thin wrapper for the profiles workstream. See orchestration.md for wave order
