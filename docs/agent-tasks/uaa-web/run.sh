#!/usr/bin/env bash
# file: docs/agent-tasks/uaa-web/run.sh
# version: 1.0.0
# guid: f1fa9d86-89c2-4229-b4c9-b7ec7adb406c
# last-edited: 2026-07-10
# Thin wrapper for the uaa-web workstream. See orchestration.md for wave order.
