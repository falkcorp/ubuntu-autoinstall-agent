#!/usr/bin/env bash
# file: docs/agent-tasks/checkin/run.sh
# version: 1.0.0
# guid: 255c0584-9747-414a-82c0-c4af4094cd85
# last-edited: 2026-07-16
# Thin wrapper for the checkin workstream. See orchestration.md for wave order
